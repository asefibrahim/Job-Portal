            ...
            <div class="markdown-component prose text-gray-300 min-w-full space-y-6">
              ...
              <ul>
                <li>
                  <pre>
                    <code>
                      You must hold a EU passport or EU work permit and work in
                      a EU country (non-negotiable)
                    </code>
                  </pre>
                </li>
              ...
              <ul>
                <li>
                  Responsible for the creation of applications that are
                  primarily in rust and some may be in python.
                </li>
                ...
                <li>
                  Working closely with frontend developers creating APIs for
                  them to use
                </li>
              ...
              <p>
                ...
                their members health; and doctors can spend more of their
                working time with their patients. We are guided by two values,
                growth and accountability.
              </p>
              <h3 className="text-2xl font-bold">Growth</h3>
              <p>
                “Someone with a growth mindset views intelligence, abilities,
                and talents as learnable and capable of improvement through
                effort. On the other hand, someone with a fixed mindset views
                those same traits as inherently stable and unchangeable over
                time.” What does this mean for our stakeholders? Company: We are
                in the business of change. We are moving the healthcare industry
                from paper based systems to web based systems. We must believe
                in the capacity for change and improvement. Growth doesn’t
                happen alone and by definition it means we don’t have all the
                answers. We believe in the power of being open to change and
                improvement. We seek opinion, we seek expertise and we make
                informed decisions based on what we learn. Learning from
                experience and integrating experience is a key component of how
                we run the business. People: We value people who don’t think
                they are done. They are looking to improve themselves, learn new
                things, try new things and benefit learning gives you –
                experience. Customers: Our customers are moving to a new way of
                doing things. They are asking their staff to learn new skills,
                to do things they haven’t done before and to embrace the chaos
                of change. We seek these customers out as ideal partners.
              </p>
              ...
              <p>
                ...
                personal responsibility for your work. It’s also trusting in
                your teammates and knowing you can count on each other to get
                things done.” What does this mean for our stakeholders? Company:
                ...
                means honesty and transparency. Accountability allows for
                failure. People: We value people who take responsibility for
                their work and complete this work to the best of their
                abilities. They don’t mind being held to account or holding
                their team to account in order to achieve better outcomes. This
                is done in a respectful and collaborative context. Customers: We
                have obligations to our customers and we must make sure we
                deliver a product that delivers exactly what we is promised.
              </p>
            </div>
          </div>
        ...
        <div class="px-4 sm:px-6 pt-6 sm:pb-2 border-t border-gray-500">
          <div class="markdown-component prose text-gray-300 min-w-full">
            ...
            <p>
              ...
              Chainlink oracles and be curious in reimagining web3 data
              transfers full time.
            </p>
